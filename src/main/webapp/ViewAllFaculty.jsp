    ...
    <div id="myTableContainer">
        <table align="center" id="myTable">
            ...
            <c:forEach items="${facultylist}" var="faculty">
                <tr>
                <td><img src='displayfacultyimage?id=${faculty.id}' width="10%" height="10%" > </td>
                    ...
                    <td> <c:out value="${faculty.active}"></c:out>   </td>
                    <td><a href="UpdateFaculty?id=${faculty.id}">Update</a>&nbsp;<a href="ViewFacultyById?id=${faculty.id}">View</a>&nbsp;<a href="DeleteFaculty?id=${faculty.id}">Delete</a></td>
                </tr>
            </c:forEach>
        </table>
    </div>
